...
NetherGate 提供完整的 Minecraft 服务器管理能力：

| 能力分类 | 状态 | 说明 |
|---------|------|------|
| SMP 协议 | ✅ 完整支持 | 35 个方法 + 22 个通知处理 |
| RCON 命令 | ✅ 完整支持 | 60+ 游戏命令封装 |
| 日志监听 | ✅ 完整支持 | 生命周期 + 玩家事件 |
| 网络事件 | ✅ 完整支持 | 4 种监听模式（LogBased 立即可用） |
| NBT 数据操作 | ✅ 完整支持 | 读取 + 写入（玩家/世界数据） |
| 数据组件 | ✅ 完整支持 | 1.20.5+ 物品组件系统 |
| 文件操作 | ✅ 完整支持 | 读写/监听/备份 |
| 性能监控 | ✅ 完整支持 | CPU/内存/TPS |
